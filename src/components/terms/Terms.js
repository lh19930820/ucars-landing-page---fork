    ...
    return (
        <section className="p-terms">
            <div className="container">
                <h5 className="p-terms__heading u-fw-600">UCARS - Revolutionizing The Online Car Marketplace In Singapore</h5>
                <div className="content-box">
                    <span className='p-terms__title u-fw-600'>
                        Buy Used And New Cars Online
                    </span>
                    <p className="p-terms__text">
